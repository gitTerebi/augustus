...
typedef enum {
    ...
    HOTKEY_NEXT_TRACK,
    HOTKEY_BUILD_REPAIR_LAND,
    HOTKEY_EDITOR_EMPIRE_DELETE_OBJECT,
    HOTKEY_EDITOR_EMPIRE_TOOL_OUR_CITY,
    HOTKEY_EDITOR_EMPIRE_TOOL_TRADE_CITY,
    HOTKEY_EDITOR_EMPIRE_TOOL_ROMAN_CITY,
    HOTKEY_EDITOR_EMPIRE_TOOL_VULNERABLE_CITY,
    HOTKEY_EDITOR_EMPIRE_TOOL_FUTURE_TRADE_CITY,
    HOTKEY_EDITOR_EMPIRE_TOOL_DISTANT_CITY,
    HOTKEY_EDITOR_EMPIRE_TOOL_BORDER,
    HOTKEY_EDITOR_EMPIRE_TOOL_BATTLE,
    HOTKEY_EDITOR_EMPIRE_TOOL_BABRIAN,
    HOTKEY_EDITOR_EMPIRE_TOOL_LEGION,
    HOTKEY_EDITOR_EMPIRE_TOOL_LAND_POINT,
    HOTKEY_EDITOR_EMPIRE_TOOL_SEA_POINT,
    HOTKEY_EDITOR_EMPIRE_TOOL_SELECTION,
    HOTKEY_EDITOR_EMPIRE_PICK_TOOL,
    HOTKEY_BUILD_COPY_CURSOR,
    HOTKEY_COPY_CURSOR_MIRROR,
    HOTKEY_MAX_ITEMS
} hotkey_action;
