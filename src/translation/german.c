...
static translation_string all_strings[] = {
    ...
    {TR_CHEAT_DESTROYED_BUILDING, "zerstörtes Gebäude"},
    ...
    {TR_CONFIG_UI_EMPIRE_SMART_BORDER_PLACMENT, "Schlaue Grenzplatzierung"},
    ...
    {TR_EDITOR_EMPIRE_PROPERTIES_SELECT_IAMGE, "Hintergrundbild wählen"},
    {TR_EDITOR_EMPIRE_PROPERTIES_DEFAULT_IAMGE, "Standart Bild"},
