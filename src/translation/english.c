...
static translation_string all_strings[] = {
    ...
    {TR_CONFIG_FIXED_WORKERS, "Fixed worker pool - 43% of plebeian population"},
    ...
    {TR_CONFIG_GRANARIES_GET_DOUBLE, "Double the capacity of cart pushers from getting granaries and warehouses"},
    ...
    {TR_HOTKEY_BUILD_COPY_CURSOR, "Copy building area"},
    {TR_HOTKEY_COPY_CURSOR_MIRROR, "Mirror copied building area"},
    ...
    {TR_HOTKEY_DUPLICATE_REPLACE_MESSAGE, "Replace existing assignment?"},
    ...
    {TR_MAIN_MENU_CONTINUE_GAME, "Continue Game"},
